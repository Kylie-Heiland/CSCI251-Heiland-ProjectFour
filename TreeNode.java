 ...
 * 11/22/22
 */
public class TreeNode<E extends Comparable<E>> extends CSCI251ProjFour
{
    E data;
    TreeNode<E> parent;
    TreeNode<E> left;
    ...
    public boolean isLeftChild(){
        if(this.parent.left == this && this.parent != null)
        {
            return true;
        }
        return false;
    ...
    public boolean isRightChild(){
       if(this.parent.right == this && this.parent != null)
        {
            return true;
        }
        return false;
